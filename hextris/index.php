...
<html lang='en'>
	...
	<body>
		...
		//if($_POST['Next']){
			...
			if(mysql_query("INSERT INTO students(name,email,age,nation,phone) VALUES('$name','$email','$age','$nation','$phone')")){
				session_start();
	...
	//	}
		...
		<div id='highScoreInGameText'>
			...
			<div style="color:#3D3D3D;">Game ends in <span id="time">01:00</span></div>
		</div>
